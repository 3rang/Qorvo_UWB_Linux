...
void _dwt_otpprogword32(uint32_t data, uint16_t address)
{
    ...
    */
    ...
    sleep(2);//Uncomment this command if you don't want to use the loop above. It will take more time than the loop above.
...
uint16_t dwt_calibratesleepcnt(void)
{
    ...
    sleep(2); //need to wait for at least 1 LP OSC period at slowest frequency of 15kHz =~ 66 us
